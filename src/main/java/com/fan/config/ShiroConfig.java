...
import com.fan.shiro.AccountRealm;
import com.fan.shiro.JwtFilter;
...
//        filterMap.put("/comment","perms[user:comment]");
//        filterMap.put("/comment", "perms[admin:test3]");
        filterMap.put("/comment", "roles[admin]"); //需要admin:test3权限
